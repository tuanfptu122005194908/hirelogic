  ...
  theme: {
    container: {
      ...
      screens: {
        ...
        xl: "1280px",
        "2xl": "1536px",
        "3xl": "1920px",  // 24 inch monitors
        "4xl": "2560px",  // 27 inch monitors
        "5xl": "3840px",  // 4K / TV screens
      },
    },
    extend: {
      fontFamily: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(255, 183, 197, 0.4)" },
          "50%": { boxShadow: "0 0 40px rgba(255, 183, 197, 0.7)" },
        },
        "slide-up": {
